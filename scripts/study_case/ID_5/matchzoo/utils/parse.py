...
def parse_loss(
    ...
    Examples::
        >>> from torch import nn
        >>> from scripts.study_case.ID_5.matchzoo.utils import parse_loss
...
def parse_metric(
    ...
    Examples::
        ...
        >>> from scripts.study_case.ID_5.matchzoo.utils import parse_metric
...
def parse_optimizer(
    ...
    Examples::
        >>> from torch import optim
        >>> from scripts.study_case.ID_5.matchzoo.utils import parse_optimizer
