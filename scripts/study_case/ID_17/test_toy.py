...
from scripts.study_case.ID_17.tf_unet import unet
...
net = unet.Unet(channels=generator.channels,cost='dice_coefficient', n_class=generator.n_class, layers=3, features_root=16)
