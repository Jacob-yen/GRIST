...
# variables:
sess = tf.Session()
tf.train.write_graph(sess.graph_def, '/data/scripts/study_case/pbtxt_files', 'GHIPS1.pbtxt')
...
scheduler = TensorFlowScheduler(name="ghips1")
'''inserted code'''

while True:
    iter_i = scheduler.iter_count
