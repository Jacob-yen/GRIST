...
from scripts.study_case.ID_4.torch_geometric.datasets import ICEWS18, GDELT  # noqa
from scripts.study_case.ID_4.torch_geometric.data import DataLoader
from scripts.study_case.ID_4.torch_geometric.nn.models.re_net import RENet
