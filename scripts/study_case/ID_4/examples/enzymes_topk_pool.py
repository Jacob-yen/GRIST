...
from scripts.study_case.ID_4.torch_geometric.nn import GraphConv, TopKPooling
from scripts.study_case.ID_4.torch_geometric.nn import global_mean_pool as gap, global_max_pool as gmp
