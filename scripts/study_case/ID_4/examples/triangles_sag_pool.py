...
from scripts.study_case.ID_4.torch_geometric.nn import GINConv, GCNConv, SAGPooling
from scripts.study_case.ID_4.torch_geometric.nn import global_max_pool
