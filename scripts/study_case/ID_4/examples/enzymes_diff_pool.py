...
from scripts.study_case.ID_4.torch_geometric.data import DenseDataLoader
from scripts.study_case.ID_4.torch_geometric.nn import DenseSAGEConv, dense_diff_pool
