...
scheduler = TensorFlowScheduler(name="ml_plactice.ch5.tb-bmi2")
'''inserted code'''

with tf.Session() as sess:
    tf.train.write_graph(sess.graph_def, '/data/scripts/study_case/pbtxt_files', 'ml_plactice_tbbmi2.pbtxt')
