...
class TestCli:
    ...
    def resolve_dotted_name(self):
        from scripts.study_case.ID_12.skorch.cli import _resolve_dotted_name
    ...
    def parse_net_kwargs(self):
        from scripts.study_case.ID_12.skorch.cli import parse_net_kwargs
    ...
    def yield_estimators(self):
        from scripts.study_case.ID_12.skorch.cli import _yield_estimators
    ...
    def substitute_default(self):
        from scripts.study_case.ID_12.skorch.cli import _substitute_default
    ...
    @pytest.fixture
    def print_help(self):
        from scripts.study_case.ID_12.skorch.cli import print_help
        return print_help
    ...
    @pytest.fixture
    def parse_args(self):
        from scripts.study_case.ID_12.skorch.cli import parse_args
        return parse_args
