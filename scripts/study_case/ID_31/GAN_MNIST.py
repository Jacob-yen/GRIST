...
tf.train.write_graph(sess.graph_def, '/data/scripts/study_case/pbtxt_files', 'tensorflow_gan_mnist.pbtxt')
sess.run(init)
...
scheduler = TensorFlowScheduler(name="GAN_MNIST")
'''inserted code'''
